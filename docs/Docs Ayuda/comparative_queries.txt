...
class ComparativeQueries:
    ...
    # =================================================================
    # 2. COMPARATIVAS DE GESTORES (CORREGIDAS CON GASTOS PRECIO REAL)
    # =================================================================

    def ranking_gestores_por_margen_enhanced(self, periodo: str) -> QueryResult:
        """
        Ranking de gestores con análisis de margen y eficiencia (enhanced).
        ✅ CORREGIDO: Usa PRECIO_POR_PRODUCTO_REAL para gastos
        """
        query = """
    ...
    def ranking_gestores_por_margen(self, periodo: str) -> QueryResult:
        """Función original compatible SQLite - CORREGIDA con gastos por PRECIO_POR_PRODUCTO_REAL."""
        query = """
            WITH ingresos_gestor AS (
                SELECT
                    g.GESTOR_ID,
    ...
    def compare_roe_gestores_enhanced(self, periodo: str) -> QueryResult:
        """ROE estandarizado (enhanced) - CORREGIDO con gastos por PRECIO_POR_PRODUCTO_REAL."""
        query = """
            WITH ingresos_gestor AS (
                SELECT
                    g.GESTOR_ID,
    ...
    # =================================================================
    # 3. COMPARATIVAS POR CENTRO (CORREGIDAS CON GASTOS PRECIO REAL)
    # =================================================================
    ...
    def compare_eficiencia_centro_enhanced(self, periodo: str) -> QueryResult:
        ...
        ✅ CORREGIDO: Usa agregación de gastos por gestor desde PRECIO_POR_PRODUCTO_REAL
        """
        query = """
    ...
    def compare_eficiencia_centro(self, periodo: str) -> QueryResult:
        """
        Versión SQL pura compatible con SQLite - CORREGIDA con gastos por PRECIO_POR_PRODUCTO_REAL.
        """
        query = """
            WITH ingresos_centro AS (
                SELECT
    ...
    def compare_margen_segmento_periodos(self, segmento_id: str, periodo_ini: str, periodo_fin: str) -> QueryResult:
        ...
        ✅ CORREGIDO: Usa PRECIO_POR_PRODUCTO_REAL para gastos por segmento
        """
        query = """
    ...
    def generate_dynamic_comparative_query(self, user_question: str, context: Dict[str, Any] = None) -> QueryResult:
        ...
        try:
            ...
            IMPORTANTE: Para gastos de gestores, centros o segmentos, usa esta lógica:
    ...
    # =================================================================
    # 6. MÉTRICAS COMPARATIVAS PARA DASHBOARDS (NUEVAS)
    # =================================================================
    ...
    def get_matriz_comparativa_segmentos(self, periodo: str = "2025-10") -> QueryResult:
        """
        ✅ Matriz comparativa de todos los segmentos (para heatmaps) - CORREGIDA con gastos por PRECIO_POR_PRODUCTO_REAL
        """
        query = """
