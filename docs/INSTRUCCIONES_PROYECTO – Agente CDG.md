...
│   │   ├── queries/
│   │   │   ├── basic_queries.py      # Consultas basicas✅
│   │   │   ├── period_queries.py      # Consultas para periodos✅
...
│   │   ├── components/
│   │   │   ├── common/
│   │   │   │   ├── Card.jsx # Card corporativa CDG basada en Ant Design con slots de header/footer y acciones.
│   │   │   │   ├── ErrorState.jsx   # Vista de error compacta con detalles desplegables y botón de reintento.
│   │   │   │   ├── Loader.jsx   # Loader corporativo: spinner, skeleton y modo pantalla completa.
│   │   │   │   ├── TopBar.jsx   # Barra superior CDG — Logo, selector de período y buscador de gestor
│   │   │   ├── Dashboard/
│   │   │   │   ├── KPICards.jsx             # Archivo que engloba los endpoints relacionados con KPIs✅
│   │   │   │   └── InteractiveCharts.jsx    # Archivo para endpoints de gráficos tanto dinámicos como predeterminados al abrir los dashboard✅
│   │   │   │   ├── DeviationAnalysis.jsx      # Análisis desviaciones en los datos de la base de datos. Mostrará desviaciones en métricas de gestores, centros, etc.✅
│   │   │   │   ├── DrillDownView.jsx        # Vista drill-down. Donde se podrá ver información del gestor a nivel de gestor/cliente o producto/contrato/ ✅
│   │   │   │   └── ChatInterface.jsx      # Interfaz chat Gestor donde se conecta al chat agent, para hacer consultas y mostrar la respuesta que ofrece el chat agent limpia✅
│   │   │   │   ├── ConversationalPivot.jsx        # Archivo donde se configura la pestaña de chat con el agente de chat para poder ejecutar las funcionalidades de gráficos dinámicos (que se mostrarán en Interactive charts)
│   │   ├── pages/
│   │   │   ├── GestorView.jsx              # Vista dashboard de gestor✅
│   │   │   ├── DireccionView.jsx      # Vista dashboard control de gestión✅
│   │   │   └── LandingPage.jsx      # Vista de la LandingP age✅
│   │   └── services/
│   │       ├── api.js                      # Conexión endpoints backend✅
│   │       ├── adminService.js             # Servicio endpoint admin✅
│   │       ├── analyticsService.js         # Servicio endpoint analytics✅
│   │       ├── reportService.js            # Servicio endpoints report✅
│   │       └── chatService.js              # Servicio endpoints chat✅
│   │   └── styles/
│   │       ├── theme.js                      # Tema✅
│   │   └── app.jsx ✅Archivo para navegar por el frontend
│   │   └── index.js ✅ 
│   │   └── index.css ✅
│   │   └── reportWebVitals.js ✅
│   ├── public/
...
La arquitectura del sistema se fundamenta en la base de datos contable BM_CONTABILIDAD_CDG.db que replica fielmente la estructura operativa de una entidad financiera, con 13 tablas interrelacionadas que capturan desde la estructura organizativa hasta los movimientos financieros y métricas de control.
