...
async def chat_websocket(websocket: WebSocket, user_id: str):
    """
    🎯 WebSocket optimizado para Chat Agent v10.0 con flujos perfectos y contexto personalizado
    """
    ...
    try:
        while True:
            ...
            # 🎯 ENRIQUECER CONTEXTO CON INFO PERSONAL
            ...
            # ✅ Crear ChatMessage para v10.0 con contexto mejorado
            try:
                chat_message_data = {
                    "user_id": user_id,
                    "message": msg,
                    "context": enhanced_context,  # ✅ CONTEXTO ENRIQUECIDO
                ...
                logger.info(f"📨 Mensaje creado - Usuario: {user_id}, Gestor: {gestor_id}, Personal: {enhanced_context.get('is_personal_query', False)}")
                ...
                logger.error(f"Error procesando mensaje para gestor {gestor_id}: {exc}")
                await websocket.send_json({
                    "type": "fallback", 
